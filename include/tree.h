//
// Created by Niccolo on 02/05/2025.
//
...
class Tree {
public:
    Tree(const std::vector<glm::mat4> &transf, const std::vector<char> &mods, std::shared_ptr<Mesh> branch, std::shared_ptr<Mesh> leaf, std::shared_ptr<Mesh> junc);
